...
func New(
	...
	app.DistrKeeper = ccvdistrkeeper.NewKeeper(
		appCodec,
		keys[ccvdistrtypes.StoreKey],
		app.GetSubspace(ccvdistrtypes.ModuleName),
		app.AccountKeeper,
		app.BankKeeper,
		&ccvstakingKeeper,
	...
	app.ConsumerKeeper = ibcconsumerkeeper.NewKeeper(appCodec, keys[ibcconsumertypes.StoreKey], app.GetSubspace(ibcconsumertypes.ModuleName),
		scopedIBCConsumerKeeper, app.IBCKeeper.ChannelKeeper,
	...
	app.StakingKeeper = *ccvstakingKeeper.SetHooks(
		ccvstakingtypes.NewMultiStakingHooks(app.DistrKeeper.Hooks()),
	)
